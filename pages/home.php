...
<section class="testimonialSlider home__testimonialSlider">
    <div class="container">
        <div class="row">
            <div class="offset-lg-6 col-lg-6"><h2 class="section-title testimonialSlider__title">Отзывы наших клиентов</h2></div>
        </div>
        ...
        <div class="testimonialSlider__container swiper-container">
            <div class="testimonialSlider__wrapper swiper-wrapper">
                ...
                <div class="testimonialSlider__slide swiper-slide">
                    ...
                    <div class="testimonialSlider__body">
                        <div class="testimonialSlider__message">
                            <div class="testimonialSlider__message-inner">
                                Понравился отель сразу тем что напоминает корабль да ещё на воде(6000м2 бассейны) 
                                ...
                                Спасибо всему обслуживающему персоналу за хорошую работу.Удачи вашему отелю так держать.Семья Лукьянченко
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonialSlider__slide swiper-slide">
                    <header class="testimonialSlider__header">
                        <figure class="testimonialSlider__figure">
                            <div class="testimonialSlider__figure-inner">
                                <img class="testimonialSlider__user-image" src="../assets/images/content/testimonial/testimonial-user-image-05.jpg" alt="Testimonial User Image">
                            </div>
                        </figure>
                        <div class="testimonialSlider-meta">
                            <div class="testimonialSlider-meta__user-name">Valentina Migun</div>
                            <div class="testimonialSlider-meta__address">Rome</div>
                        </div>
                        <div class="testimonialSlider__date">10.12.2019</div>
                    </header>
                    <div class="testimonialSlider__body">
                        <div class="testimonialSlider__message testimonialSlider__message_video">
                            <div class="testimonialSlider__message-inner">
            ...
            <!-- thumbs -->
            <div class="testimonialSlider-thumbs">
                <ul class="testimonialSlider-thumbs__list">
                    <li class="testimonialSlider-thumbs__list-item testimonialSlider-thumbs__list-item_current">
                        <div class="testimonialSlider-thumbs__user-image">
                            <img class="testimonialSlider-thumbs__image" src="../assets/images/content/testimonial/testimonial-user-image-01.jpg" alt="Testimonial User Thumb Image">
                        </div>
                    </li>
                    <li class="testimonialSlider-thumbs__list-item">
                        <div class="testimonialSlider-thumbs__user-image">
                            <img class="testimonialSlider-thumbs__image" src="../assets/images/content/testimonial/testimonial-user-image-02.jpg" alt="Testimonial User Thumb Image">
                        </div>
                    </li>
                    <li class="testimonialSlider-thumbs__list-item">
                        <div class="testimonialSlider-thumbs__user-image">
                            <img class="testimonialSlider-thumbs__image" src="../assets/images/content/testimonial/testimonial-user-image-03.jpg" alt="Testimonial User Thumb Image">
                        </div>
                    </li>
                    <li class="testimonialSlider-thumbs__list-item">
                        <div class="testimonialSlider-thumbs__user-image">
                            <img class="testimonialSlider-thumbs__image" src="../assets/images/content/testimonial/testimonial-user-image-04.jpg" alt="Testimonial User Thumb Image">
                        </div>
                    </li>
                    <li class="testimonialSlider-thumbs__list-item">
                        <div class="testimonialSlider-thumbs__user-image">
                            <img class="testimonialSlider-thumbs__image" src="../assets/images/content/testimonial/testimonial-user-image-05.jpg" alt="Testimonial User Thumb Image">
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <!-- Nav Buttons -->
            <div class="testimonialSlider-navigation">
                <div class="testimonialSlider__button-prev">
                    <svg class="property-slider__icon-arrow icon-arrow">
                        <use xlink:href="/assets/images/symbol/sprite.svg#icon__arrow"></use>
                    </svg>
                </div>
                <div class="testimonialSlider__button-next">
                    <svg class="property-slider__icon-arrow icon-arrow">
                        <use xlink:href="/assets/images/symbol/sprite.svg#icon__arrow"></use>
                    </svg>
                </div>
