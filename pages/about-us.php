...
<main class="about-us">
    ...
    <!--== About Page Text  -->
    <section class="about-us__text-block">
        <div class="container">
                ...
                <div class="row">
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 offset-md-1 col-md-10">
                        <div class="about-us__slogan">
                            Максимальное удовлетворение ожиданий клиентов результатами взаимного сотрудничества
                        </div>
                    </div>
                </div>
            </div>
            <div class="about-us__deco"></div>
        </div>
    </section>
                    ...
                    <div class="checklist-block__content">
                        ...
                        <div class="checklist-block__text-content typography">
                            <ul>
                                ...
                                <li>Успешный опыт работы и знание зарубежного рынка недвижимости</li>
                                <li>Организацию полноценных туров по просмотру понравившихся вариантов</li>
                                <li>Дружный и сплочённый коллектив профессионалов, увлечённых своим делом</li>
                                <li>Индивидуальный подбор недвижимости в Турции для <br>покупки и аренды с учётом целей, и всех пожеланий <br>наших клиентов</li>
                                <li>Послепродажный сервис и грамотное управление собственностью</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!--== Privilages Cards  -->
    <section class="about-us__privilages">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="privilages-card privilages-card_safe">
                        ...
                        <div class="privilages-card__body">
                            <div class="privilages-card__title">Надёжность</div>
                            <div class="privilages-card__text">Надежность – важнейший критерий компании, который мы 
                            подтверждаем нашей хорошей репутацией, стабильным успехом и доверительными 
                            отношениями с клиентами.</div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="privilages-card privilages-card_clear">
                        ...
                        <div class="privilages-card__body">
                            <div class="privilages-card__title">Прозрачность</div>
                            <div class="privilages-card__text">Мы предоставляем полную, своевременную, честную информацию 
                            покупателям и партнерам, на основе которой принимаются выгодные, правильные решения.</div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                ...
                <div class="col-xl-6 col-lg-4 col-md-6">
                    <div class="privilages-card privilages-card_horiz privilages-card_trust">
                        ...
                        <div class="privilages-card__body">
                            <div class="privilages-card__title">Доверие</div>
                            <div class="privilages-card__text">Мы верим, что открытые, доверительные партнерские 
                            взаимоотношения с нашими покупателями дают возможность глубже понять их потребности и 
                            сделать счастливее.</div>
                        </div>
                    </div>
                </div>
            </div>
