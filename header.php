                ...
                <div class="head-meta__row">
                    <div class="head-meta__item">
                        <div class="head-meta__phone-list">
                            <select name="phone-number__list" class="head-meta__phone-select theme-select">
                    ...
                    <div class="head-meta__item">
                        <div class="head-meta__email">
                            <a href="mailto:turkeystate@gmail.com" title="turkeystate@gmail.com">turkeystate@gmail.com</a>
                        </div>
                    </div>
                    ...
                    <div class="head-meta__item">
                        <div class="head-meta__language">
                            <select name="language" class="head-meta__lng-select theme-select">
                    ...
                    <div class="head-meta__item">
                        <div class="head-meta__currency">
                            <select name="language" class="head-meta__curr-select theme-select">
