            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="footer-widget__content footer-widget__content--no-title">
                            ...
                            <div class="footer-widget__title-content">Адресс:</div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="footer-widget__content footer-widget__content--no-title">
                            ...
                            <div class="footer-widget__title-content">Почта:</div>

                            <ul class="footer-widget__list">
                                <li class="footer-widget__list-item footer-widget__list-item--email"><a href="mailto:turkeystate@gmail.com" class="footer-widget__link link">turkeystate@gmail.com</a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="footer-widget__title">Полезные ссылки</div>
