...
var searchCollaps = function searchCollaps() {
  var searchBtn = document.querySelector(".nav__search-btn");
  var searchCollaps = document.querySelector(".nav__search-collaps");
  var searchArea = document.querySelector(".nav__search-area");
  var serchIcon = document.querySelector(".nav__search-icon");
...
var searchFormTabs = function searchFormTabs() {
  $(document).on("click", ".search-form__tab", function () {
    ...
    $(".search-form__tab").removeClass("search-form__tab_current"); // $(".search-form__tab-content").removeClass(
    //     "search-form__tab-content_current"
    // );

    $(this).addClass("search-form__tab_current"); // $(".search-form__tab-content_" + tabName).addClass(
    //     "search-form__tab-content_current"
    // );
  });
}; // Meta Dropdown List
...
var testimonialSlider = function testimonialSlider() {
  ...
  testimonialSlider.on("slideChange", function () {
    var slideThumb = $(".testimonialSlider-thumbs__list-item");
    var currentIndex = testimonialSlider.activeIndex;
  ...
  $(document).on("click", ".testimonialSlider-thumbs__list-item", function () {
    var slideThumb = $(".testimonialSlider-thumbs__list-item");
    var current = slideThumb.index(this);
    slideThumb.removeClass("testimonialSlider-thumbs__list-item_current");
...
var scrollToTop = function scrollToTop() {
  ...
  $(window).scroll(function () {
    var btnPostition = function btnPostition() {
      if ($(window).scrollTop() + $(window).height() + 50 > $(document).height()) {
        toTopBtn.css("bottom", "115px"); // alert('hey')
      } else {
...
var anchorToggle = function anchorToggle() {
  $(document).on("click", ".button__anchor", function (e) {
    // e.preventDefault();
    $(this).addClass("button__anchor_active").siblings().removeClass("button__anchor_active");
  }); // Slide to Anchor
...
var imageSlider = function imageSlider() {
  var sliderSelector = ".slider-container",
  ...
  $(".slider-item a").magnificPopup({
    type: "image" // cursor: 'mfp-zoom-out-cur',
    // gallery:{
    //     enabled:true
    // }
...
var stickyTabs = function stickyTabs() {
  var $window = $(window);
...
var phoneFomMask = function phoneFomMask() {
